...
//                if (deviceVID != 0x1d6b && (devicePID != 0x0001 && devicePID != 0x0002 && devicePID != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
    ...
    public void resSetBaudRate() {
        int baudrateID = getSharedPreferences("config", MODE_PRIVATE).getInt("baudrate", 12);
        int baudrate = getResources().getIntArray(R.array.baudrates_value)[baudrateID];
        if (serialPort != null && serialPort.isOpen()) serialPort.setBaudRate(baudrate);
    }
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            ...
            int baudrateID = getSharedPreferences("config", MODE_PRIVATE).getInt("baudrate", 12);
            int baudrate = getResources().getIntArray(R.array.baudrates_value)[baudrateID];
            Log.e("serialPort", "baudrateID=" + baudrateID);
            Log.e("serialPort", "baudrate=" + baudrate);
            if (serialPort != null) {
                if (serialPort.open()) {
